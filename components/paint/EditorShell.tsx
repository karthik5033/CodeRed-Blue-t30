            ...
            <header className="h-16 px-6 border-b border-gray-100 flex items-center justify-between bg-white z-50">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/visual-builder">
                        <button className="px-4 py-2 text-sm font-medium text-purple-700 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 transition-colors shadow-sm flex items-center gap-2">
                            <Wand2 className="w-4 h-4" />
                            Visual Builder
                        </button>
                    </Link>
                    <Link href="/ai-builder">
                        <button className="px-4 py-2 text-sm font-medium text-indigo-700 bg-indigo-50 border border-indigo-200 rounded-lg hover:bg-indigo-100 transition-colors shadow-sm flex items-center gap-2">
